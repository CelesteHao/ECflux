...
# config
# ---------------------------------------
data_in = 'C:/research_function/Hn1/nc_test/'
dz = 0  # zero plane displacement, unit: m
output_path = data_in + 'flux' + 'Hn1' + '.xlsx'  # output path
dates = pd.date_range('2018.07.01', '2018.07.05')  # modify based on the date_in
